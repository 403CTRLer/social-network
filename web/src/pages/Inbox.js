										...
										<div className="inbox_msg">
											<div className="inbox_people">
												...
												<div className="inbox_chat">
													<div id="sponsoredLayout" style={{ margin: 20 }}></div>
													<div id="friends">
														{friends.map(function (friend) {
															return (
																<div style={{ display: "contents" }} key={`friend-${friend._id}`}>
																	{friend.status === "Accepted" && (
																		<div
																			className={`chat_list ${selectedFriend?._id === friend._id ? "active" : ""}`}
																			onClick={function () {
																			...
																			<div className="chat_people">
																				...
																				<div className="chat_ib">
																					<h5>
																						{friend.name}
																						{friend.unread > 0 && (
																							<span className="badge unread" style={{ backgroundColor: "#05728f", color: "white" }}>
																								{friend.unread}
																							</span>
																						)}
																					</h5>
											...
											<div className="mesgs">
												{selectedFriend ? (
													<div className="msg_history" id="msg_history" style={{ clear: "both" }}>
														{messages.map(function (message) {
															return (
																<div style={{ display: "contents" }} key={`message-${message._id}`}>
																	{message.from === user?._id ? (
																		<div className="outgoing_msg" data-message-id={message._id}>
																			<div className="sent_msg">
																				...
																				{message.is_deleted && (
																					<i className='fa fa-trash pull-right' onClick={function () { deleteMessage(message._id); }}></i>
																				)}
																			</div>
																		</div>
																	) : (
													...
													<div className="type_msg">
														<div className="input_msg_write">
															...
															>
																...
																<div className="attachments" style={{ display: "flex", paddingRight: 0, paddingLeft: 0, border: "none" }}>
																	<ul>
																		<li>
																		...
																		<li>
																			<i className="fa fa-microphone" id="icon-record-audio" onClick={function () { recordAudio(); }} style={{ cursor: "pointer" }}></i>
																		</li>
																	</ul>
																</div>
