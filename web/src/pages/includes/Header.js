				...
				<nav id="menu" className="res-menu">
					{user === null ? (
						<ul id="main-menu-mobile">
							...
							<li>
								<Link to="/Signup">
									Signup <i className="fa fa-angle-right"></i>
								</Link>
							</li>
						</ul>
					) : (
					...
					<ul className="main-menu" id="main-menu">
						{user === null ? (
							...
							<>
								<li>
									<Link to="/Friends">
										Friends <i className="fa fa-angle-right"></i>
									</Link>
								</li>
								<li>
									<Link to="/Pages">
								...
								<li>
									<Link to="/Groups">
										Groups <i className="fa fa-angle-right"></i>
									</Link>
								</li>
								<li>
									<Link to="/UpdateProfile">
										Profile ({user.name}) <i className="fa fa-angle-right"></i>
									</Link>
								</li>
								<li>
									<a href="#" onClick={onClickLogout} disabled={loggingOut}>
