...
function Footer() {
	...
	const visibleLikers = useSelector((state) => state.likers);
	const visibleDislikers = useSelector((state) => state.dislikers);
	const postComments = useSelector((state) => state.postComments);
	const postSharers = useSelector((state) => state.postSharers);
	...
	async function doPostComment(event) {
	...
	return (
		<div>
			<footer style={{ minHeight: '80px', padding: '20px 0', backgroundColor: '#f5f5f5' }}>
				<div className="container">
					<div className="row">
						<div className="col-12 text-center">
							<p style={{ marginBottom: '0' }}>Social Network &copy; {year}. Developed by <a href="https://github.com/403CTRLer" target="_blank">403CTRLer</a></p>
						</div>
					</div>
				</div>
			</footer>
